...
subject = '!!!!!!!!  Error processing ' + vendor + ' inventory !!!!!!!!!' 
text = 'There is an error processing ' + vendor + ' inventory, please check on var\log\cron the file ' + vendor + '.log for details'
